...
Projeto e documentação fornecidos no curso de formação em boas práticas de Python, fornecido pela Alura. Este projeto é uma API criada com FastAPI para recomendação de produtos baseada no histórico de compras de usuários e preferências como categorias e tags.
